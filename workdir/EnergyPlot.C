...
newtree->Draw("log10(CalEnergyRaw):log10(McEnergy)>>hist",cut01);
hist->SetTitle("Incident Energy vs Energy Deposited/Path Length");
hist->SetXTitle("Log10(Incident Energy) (MeV)");
hist->SetYTitle("Log10(Deposited Energy/(Path Length)) (MeV/cm)");
hist->Draw("colz");
...
hist.Delete();
TH2F *hist = new TH2F("hist","hist",bin,4.5,7,bin,3.75,6.5);
newtree->Draw("log10(CalEnergyRaw):log10(McEnergy)>>hist",cut12);
hist->SetTitle("Incident Energy vs Energy Deposited/Path Length");
hist->SetXTitle("Log10(Incident Energy) (MeV)");
hist->SetYTitle("Log10(Deposited Energy/(Path Length)) (MeV/cm)");
hist->Draw("colz");
...
hist.Delete();
TH2F *hist = new TH2F("hist","hist",bin,4.5,7,bin,3.75,6.5);
newtree->Draw("log10(CalEnergyRaw):log10(McEnergy)>>hist",cut23);
hist->SetTitle("Incident Energy vs Energy Deposited/Path Length");
hist->SetXTitle("Log10(Incident Energy) (MeV)");
hist->SetYTitle("Log10(Deposited Energy/(Path Length)) (MeV/cm)");
hist->Draw("colz");
...
hist.Delete();
TH2F *hist = new TH2F("hist","hist",bin,4.5,7,bin,3.75,6.5);
newtree->Draw("log10(CalEnergyRaw):log10(McEnergy)>>hist",cut34);
hist->SetTitle("Incident Energy vs Energy Deposited/Path Length");
hist->SetXTitle("Log10(Incident Energy) (MeV)");
hist->SetYTitle("Log10(Deposited Energy/(Path Length)) (MeV/cm)");
hist->Draw("colz");
...
hist.Delete();
TH2F *hist = new TH2F("hist","hist",bin,4.5,7,bin,3.75,6.5);
newtree->Draw("log10(CalEnergyRaw):log10(McEnergy)>>hist",cut);
hist->SetTitle("Incident Energy vs Energy Deposited/Path Length");
hist->SetXTitle("Log10(Incident Energy) (MeV)");
hist->SetYTitle("Log10(Deposited Energy/(Path Length)) (MeV/cm)");
hist->Draw("colz");
